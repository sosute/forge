/******/ (() => {
  ...
  chrome.action.onClicked.addListener(
    /*#__PURE__*/ (function () {
      var _ref = _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee(tab) {
          var isInitialRun,
            ...
            function (_context) {
              while (1)
                switch ((_context.p = _context.n)) {
                  case 0:
                    console.log(
                      '[Background] Extension icon clicked for tab:',
                      tab.url
                    );
                    _context.p = 1;
                    if (
                      !(
                        !(tab !== null && tab !== void 0 && tab.id) ||
                        !tab.url ||
                    ...
                    console.log(
                      '[Background] Invalid tab for content script injection'
                    );
                    return _context.a(2);
                  case 2:
                    ...
                    console.log(
                      '[Background] Is initial run for tab:',
                      isInitialRun
                    );
                  ...
                  case 11:
                    ...
                    if (
                      ...
                      console.log(
                        '[Background] Check completed successfully, drawer should be visible'
                      );
                  ...
                  case 14:
                    console.log(
                      '[Background] Fallback message sent via window.postMessage'
                    );
                  ...
                  case 15:
                    ...
                    _t4 = _context.v;
                    console.error(
                      '[Background] Fallback communication also failed:',
                      _t4
                    );
                  case 16:
                    _context.n = 18;
                  ...
                  case 17:
                    ...
                    _t5 = _context.v;
                    console.error(
                      '[Background] Extension icon click failed:',
                      _t5
                    );
                  case 18:
                    return _context.a(2);
  ...
  chrome.tabs.onRemoved.addListener(function (tabId, _removeInfo) {
    ...
    if (tabCheckState.has(tabId)) {
      tabCheckState['delete'](tabId);
      console.log(
        '[Background] Tab check state cleaned up for closed tab:',
        tabId
      );
    }
  });
