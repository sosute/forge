...
// ハイライトから除外するタグ
export const EXCLUDE_HIGHLIGHT_TAGS = [
  'BODY',
  'HTML',
  'MAIN',
  'HEADER',
...
export const ALLOWED_SIMPLE_TAGS = [
  'BR',
  'A',
  'STRONG',
  'EM',
...
// 装飾目的のHTMLタグ（非推奨）
export const PRESENTATIONAL_TAGS = [
  'FONT',
  'CENTER',
  'U',
  'S',
...
// インラインセマンティックタグ
export const INLINE_SEMANTIC_TAGS = [
  'STRONG',
  'EM',
  'MARK',
  'CODE',
